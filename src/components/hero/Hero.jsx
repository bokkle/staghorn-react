    ...
    >
      ...
      <div className="land flex h-full flex-col items-center justify-center landscape:pt-14 lg:landscape:pt-0">
        ...
        <div className="mt-6 grid w-[280px] gap-5 md:mt-8 md:w-[500px] md:grid-cols-2 lg:mt-10">
          <button
            className="cursor-pointer bg-emerald-600 font-semibold text-zinc-100 ring ring-emerald-600 transition-all duration-300 ease-out hover:bg-emerald-800 hover:ring-emerald-800 active:scale-95 md:text-xl font-sans"
          ...
          <button
            className="cursor-pointer font-semibold capitalize text-zinc-100 ring ring-emerald-600 transition-all duration-300 ease-out hover:bg-emerald-800 hover:ring-emerald-800 active:scale-95 md:text-xl font-sans"
            style={{ textShadow: '0 0 2px black' }}
          >
